...
protected:
	...
	static void ValueString(ISerialize *ser, mono::string name, mono::string &str, int policy);
	static void ValueInt(ISerialize *ser, mono::string name, int &obj, int policy);
	...
	static void ValueFloat(ISerialize *ser, mono::string name, float &obj, int policy);
	static void ValueVec3(ISerialize *ser, mono::string name, Vec3 &obj, int policy);
	static void ValueQuat(ISerialize *ser, mono::string name, Quat &obj, int policy);
