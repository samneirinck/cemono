...
namespace CryEngine
{
    partial class CryConsole
    {
        ...
        // CVars
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern protected static void _RegisterCVarFloat(string name, ref float val, float defaultVal, CVarFlags flags, string description);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern protected static void _RegisterCVarInt(string name, ref int val, int defaultVal, CVarFlags flags, string description);
        /*[MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern protected static void _RegisterCVarString(string name, ref string val, string defaultVal, CVarFlags flags, string description);*/
