...
namespace CryEngine.Native
{
    internal interface INativePhysicsMethods
    {
		...
		int RayWorldIntersection(Vec3 origin, Vec3 dir, EntityQueryFlags objFlags, RayWorldIntersectionFlags flags, ref RaycastHit rayHit, int maxHits, object[] skipEnts);
		...
		void SimulateExplosion(pe_explosion explosion);
