...
public:
  ...
  virtual void ClientHit(const HitInfo &hitInfo);
	...
	virtual void OnExplosion(const ExplosionInfo &explosionInfo, TExplosionAffectedEntities affectedEntities);
  ...
  DECLARE_CLIENT_RMI_NOATTACH(ClVotingStatus, VotingStatusParams, eNRT_ReliableUnordered);
	...
	DECLARE_CLIENT_RMI_NOATTACH(ClPlayerLeaved, RenameEntityParams, eNRT_ReliableUnordered);
