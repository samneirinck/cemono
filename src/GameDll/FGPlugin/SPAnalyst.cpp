...
//	 - 31:05:2008		 : FGPlugin Modified - KAK
//
////////////////////////////////////////////////////////////////////////////
...
// [FGP] Include FGPlugin game
#include "FGPluginGame.h"
// [/FGP]
...
void CSPAnalyst::OnLoadingStart(ILevelInfo *pLevelInfo)
{
	...
	// [FGP] Use starting level
	string szLevel; ((CFGPluginGame*)g_pGame)->GetStartingLevel(szLevel);
	if (stricmp(pLevelInfo->GetName(), szLevel.c_str()) == 0 || !m_bChainLoad)
	{
