...
#include "Menus\FlashMenuScreen.h"
...
#include "Menus\GameNetworkProfile.h"
#include "SPAnalyst.h"
#include "Menus\MovieManager.h"

// [FGP] Include FGPluginGame
...
void CFlashMenuObject::InitStartMenu()
{
	...
	if(!m_apFlashMenuScreens[MENUSCREEN_FRONTENDSTART]->IsLoaded())
	{
		...
		{
			// [FGP] Append symbol to mod name
			string szModName = info.m_name;
			szModName += " [FGP]";
			m_apFlashMenuScreens[MENUSCREEN_FRONTENDSTART]->Invoke("addLoadedModText",szModName.c_str());
			// [/FGP]
		}
